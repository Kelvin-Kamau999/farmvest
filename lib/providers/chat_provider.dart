...
import 'package:cofarmer/models/message_model.dart';
...
class ChatProvider with ChangeNotifier {
  ...
  Future<void> sendMessage(String userId, MessageModel message) async {
    ...
    if (message.mediaFiles!.isNotEmpty) {
      ...
      final initiator =
          FirebaseFirestore.instance.collection('chats').doc('${uid}_$userId');
      final receiver =
          FirebaseFirestore.instance.collection('chats').doc('${userId}_$uid');
